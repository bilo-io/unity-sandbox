...
namespace MetaBuddy.UI.ErrorRow
{
    ...
    {
        private readonly StyleCache _oddStyle = new StyleCache(new Styles.ErrorRow(StyleConstants.StrongMidGrey));
        private readonly StyleCache _evenStyle = new StyleCache(new Styles.ErrorRow(StyleConstants.WeakMidGrey));
        ...
        )
        {
            ...
            if (current.type == EventType.ContextClick && GUILayoutUtility.GetLastRect().Contains(current.mousePosition))
            {
